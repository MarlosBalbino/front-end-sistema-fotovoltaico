...
const ControlSolutionInfo: React.FC = () => {
  const [mostrarMais, setMostrarMais] = useState(false);

  return (
    <section className={style.section}>
      <h2 className={style.h2}>Análise CA e Solução de Controle</h2>
      <div className={style.alguma_coisa}>
        <p>Conteúdo sobre análise em corrente alternada e solução de controle</p>          
      </div>
...
export default ControlSolutionInfo;
